...
import 'package:instgramclone/view/screen/instgrampage.dart';
...
class Profile extends StatelessWidget {
    ...
    return DefaultTabController(length: 2,
                      ...
                      child: Column(
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: CircleAvatar(
                              child: ClipOval(
                                child:checkUrl(_users.imageurl!)
                              ),
                            ),
                          ),
                          Padding(
                            padding: EdgeInsets.only(top: 10,bottom: 10),
                            child: Text(_users.firstname!,
                ...
                Row(mainAxisAlignment: MainAxisAlignment.end,children: [
                  ...
                  Padding(
                    ...
                    child: Container(decoration: BoxDecoration(
                      ...
                      Center(child: Text("تعديل الملف الشخصى",style: TextStyle(fontWeight: FontWeight.bold),)),),
                  ),
                ],),
              Padding(
                ...
                child: Container(child:ListView.builder(
                  ...
                  return Padding(
                    ...
                    child: Container(height: 130,child: SingleChildScrollView(
                      child: Column(children: [
                        SizedBox(
                          ...
                          child: CircleAvatar(
                            child: ClipOval(
                                child:checkUrl(users![index].imageurl!)
                            ),
                          ),
                        ),
                        Text(users![index].firstname!),
                           GestureDetector(onTap: ()async{
                            await addfollower(curerntuser: _users, index: index);
                            _profilecontroller.follow.value="followed";
                            print("done");
                          },
                            child:
                               Container(height:50,width: 100,color: Colors.blue,
                                child: Center(child:
                                _users.followers!.contains(users![index].id)?
                                    Text( "followed",
                                    style: TextStyle(fontWeight: FontWeight.bold
                                        ,fontSize: 25),):
                                Obx(() =>Text(_profilecontroller.follow.value,style: TextStyle(
     ...
     Tab(icon:Icon (Icons.video_camera_front,color: Colors.black))]
       ...
       Expanded(
          ...
          StreamBuilder(stream:FirebaseFirestore.instance.collection(Consts.users).doc(_users.id)
  ...
  Future<void>addfollower({@required Users? curerntuser,@required int? index})async{
